...
def upgrade() -> None:
    ...
    op.drop_index(op.f('idx_global_provider_configs_name'), table_name='global_provider_configs')
    op.drop_index(op.f('idx_global_provider_configs_type'), table_name='global_provider_configs')
    op.drop_index(op.f('idx_global_provider_configs_user'), table_name='global_provider_configs')
    op.drop_table('global_provider_configs')
    op.drop_index(op.f('idx_provider_templates_name'), table_name='provider_setting_templates')
    op.drop_index(op.f('idx_provider_templates_type'), table_name='provider_setting_templates')
...
def downgrade() -> None:
    ...
    op.create_table('provider_setting_templates',
    ...
    op.create_table('global_provider_configs',
    sa.Column('id', sa.INTEGER(), autoincrement=True, nullable=False),
    sa.Column('provider_type', sa.VARCHAR(length=50), autoincrement=False, nullable=False),
    sa.Column('provider_name', sa.VARCHAR(length=100), autoincrement=False, nullable=False),
