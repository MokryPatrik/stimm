...
export function DocumentList({ ragConfigId, refreshTrigger }: DocumentListProps) {
    ...
    const loadDocuments = useCallback(async () => {
        try {
            ...
            const response = await fetch(`http://localhost:8001/api/rag-configs/${ragConfigId}/documents`)
            if (!response.ok) {
