            ...
            <div className="bg-gradient-to-br from-blue-900 to-purple-900 border border-white/20 rounded-xl p-6 shadow-2xl w-full max-w-4xl mx-4">
                ...
                {agents.map(agent => (
                  ...
                  >
                    ...
                    <a
                      ...
                      className="absolute top-2 right-2 p-2 rounded-lg bg-white/10 hover:bg-white/20 border border-white/20 transition-all opacity-0 group-hover:opacity-100"
              ...
              <div className="mt-6 pt-4 border-t border-white/10 flex justify-between items-center">
                <div className="flex gap-2">
                  <a
                    href="/agent/admin"
                    className="px-4 py-2 rounded-lg bg-white/10 hover:bg-white/20 border border-white/20 text-white text-sm transition-all flex items-center gap-2"
                  >
